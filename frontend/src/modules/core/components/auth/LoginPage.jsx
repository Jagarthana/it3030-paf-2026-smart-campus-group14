    ...
    <div className="min-h-screen bg-sliit-light flex items-center justify-center p-4">
      <div className="max-w-4xl w-full bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="bg-sliit-blue text-white p-12 flex flex-col justify-center items-start md:w-5/12 relative overflow-hidden">
          ...
          <h1 className="text-4xl font-bold mb-4">SLIIT<br/>Courseweb Hub</h1>
            ...
            <>
              <div className="mt-6 border-t border-slate-200 pt-6">
                <button 
                  ...
                  type="button" 
                  className="w-full py-2 px-4 border border-slate-300 rounded-lg font-semibold text-slate-700 bg-white hover:bg-slate-50 transition-all shadow-sm flex justify-center items-center gap-3"
                >
                  <LogIn className="w-5 h-5 text-red-500" /> Sign In via Google Workspace
                </button>
              </div>
